 ...
 * Use the [LoginPwdFragment.newInstance] factory method to
...
class LoginPwdFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        linkSignUp.setOnClickListener {
            ...
            controller.navigate(R.id.action_loginPwdFragment_to_signUpInputPhoneFragment)
        }
    }
